...
df2=pd.read_csv('./Modeling_of_APUF_Compositions/64bit/HalfMillion/LSPUF/LSPUF_6_5/o1_lspuf.csv',header=None)
...
X = np.array(df1.iloc[:399999,:65])
Y = np.array(df2.iloc[:399999,:])
...
np.savez('LSPUF_result', acc, acc_bnn)
